...
from asshole.player.CardGameListenerInterface import CardGameListenerInterface
...
class AbstractPlayer(CardGameListenerInterface):
    ...
    # Inform the player if a given meld will split the cards
...
def main():
    ...
    # Make a new player without a GM
